  ...
  return (
    <>
      <div className="col-sm col-md mb-2">
        <MapContainer center={[50.83, 4.34]} zoom={11} scrollWheelZoom={true}>
          <TileLayer
            attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
            url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
          />

         // Check if the farmer data has prod property // Sets prop state in product
          {farmerData.map((frmr) => {
            const myHandleShow = () => {
              if ("products" in frmr) {
